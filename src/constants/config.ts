export const CONFIG = {
  tries: 3, // This changes how many tries you get to finish the game
  language: 'ENG', // This changes the display name for your language
  wordLength: 5, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'Argelia', // Put your name here so people know who made this game!
